...
def _build_instructions(clients: dict) -> str:
    parts: list[str] = [
        ...
        "Ниже перечислены рекомендуемые приложения для разных платформ. Однако подойдут любые клиенты, поддерживающие VLESS и импорт конфигурации по ссылке/QR-коду. <a href=\"https://github.com/Resetand/3x-ui-vpn-bot/wiki/%D0%9F%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F-%D0%BA%D0%BB%D0%B8%D0%B5%D0%BD%D1%82%D1%8B\">Подробнее в небольшой статье</a>.\n",
    ]
